                ...
                {else}
                  <div class="posi_rel">
                    ...
                    <img
                      ...
                      alt="{$product.name}" class="product_gallery_no_picture"
                    />
                  </div>
                {/if}
              {/block}
        ...
        <div class="product_middle_column col-lg-{$sttheme.pro_primary_column_md} mb-3">
          ...
          {if $sttheme.product_summary_location==0 || ($sttheme.product_summary_location==2 && !$sttheme.is_mobile_device)}
              {block name='product_description_short'}
                <div id="product-description-short-{$product.id}" class="product-description-short mb-3 truncate_block st_showless_block_{if !empty($sttheme.showless_short_desc)}1{else}0{/if} truncate_cate_desc_{$sttheme.truncate_short_desc}" {if $sttheme.google_rich_snippets} itemprop="description" {/if}><div class="st_read_more_box">{$product.description_short nofilter}</div><a href="javascript:;" title="{l s='Read more' d='Shop.Theme.Panda'}" class="st_read_more" rel="nofollow"><span class="st_showmore_btn">{l s='Read more' d='Shop.Theme.Panda'}</span><span class="st_showless_btn">{l s='Show less' d='Shop.Theme.Panda'}</span></a></div>
