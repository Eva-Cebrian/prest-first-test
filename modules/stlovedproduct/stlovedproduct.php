...
class StLovedProduct extends Module implements WidgetInterface
{
	...
	public function __construct()
	{
        ...
        self::$position = array(
            ...
            11 => array(
                'id' => 'pos_11',
                'value' => 11,
                'label' => $this->getTranslator()->trans('Beside product name', array(), 'Admin.Theme.Panda')
            ),
        ); 
    ...
    {
        $this->_tabs = array(
            array('id'  => '0,1,6,5', 'name' => $this->getTranslator()->trans('General settings', array(), 'Admin.Theme.Panda')),
    ...
    protected function initForm()
    {
        $this->fields_form[0]['form'] = array(
			...
			'input' => array(
                ...
                array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Active color:', array(), 'Admin.Theme.Panda'),
        ...
        $this->fields_form[6]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Settings for love icons on the product image', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs'
            ),
            'input' => array(
                array(
                    'type' => 'radio',
                    'label' => $this->getTranslator()->trans('How to display:', array(), 'Modules.Stlovedproduct.Admin'),
                    'name' => 'show_love_icon',
                    'default_value' => 0,
                    'values' => array(
                        array(
                            'id' => 'show_love_icon_0',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Display the love icon out when mouse hover.', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'show_love_icon_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Always display the love icon .', array(), 'Admin.Theme.Panda')),
                    ),
                    'validation' => 'isUnsignedInt',
                ),
                array(
        ...
        $this->fields_form[5]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'validation' => 'isBool',
                    'desc' => $this->getTranslator()->trans('For cacheing reason the number of loves can only be display on the product page.', array(), 'Admin.Theme.Panda'),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Icon size:', array(), 'Admin.Theme.Panda'),
    ...
    public function hookActionProductDelete($params)
    {
        ...
        Db::getInstance()->execute('DELETE FROM '._DB_PREFIX_.'st_loved_product
           WHERE type = 1 AND id_source = '.(int)$id_product);
    }
}