...
class StBrandsSlider extends BaseSlider implements WidgetInterface
{
    ...
    public function initFieldsForm()
    {
        ...
        $fields['home_slider']['grid']['values']=array(
            array(
                'id' => 'grid_slider',
                'value' => 0,
    ...
    private function _prepareHook($ext='')
    {
        ...
        if($rewind_nav && (int)Configuration::get($this->_prefix_stsn.'PRO_PER_FW')>count($brands)){
            $rewind_nav=false;
        }
		...
		$this->smarty->assign(array(
            ...
            'display_as_grid'               => Configuration::get($this->_prefix_st.'GRID'.$ext),
	        ...
	        'slider_reverse_direction'         => Configuration::get($this->_prefix_st.'REVERSE_DIRECTION'.$ext),
            'slider_pause_on_enter'         => Configuration::get($this->_prefix_st.'PAUSE_ON_ENTER'.$ext),
            'rewind_nav'                    => Configuration::get($this->_prefix_st.'REWIND_NAV'.$ext),
