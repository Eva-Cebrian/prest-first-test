...
<div id="brands_slider_container_{$hook_hash}" class="brands_slider_container {if $hide_mob == 1} hidden-md-down {elseif $hide_mob == 2} hidden-lg-up {/if} block products_container {if $has_background_img || $video_mpfour} jarallax {/if}" 
...
<section id="brands_slider_{$hook_hash}" class="brands_slider">
    ...
    {if $title_position!=3 && $display_as_grid!=1}
        <div class="title_block flex_container title_align_{(int)$title_position} title_style_{(int)$sttheme.heading_style} {if isset($sub_title) && $sub_title} st_has_sub_title {/if}">
            ...
            <a href="{$link->getPageLink('manufacturer')}" class="title_block_inner" title="{if isset($title) && $title}{$title}{else}{l s='Product Brands' d='Shop.Theme.Panda'}{/if}">{if isset($title) && $title}{$title}{else}{l s='Product Brands' d='Shop.Theme.Panda'}{/if}</a>
    ...
    {if $display_as_grid!=1}
        ...
        {/if}
            ...
            {if isset($view_more) && $view_more}<div class="product_view_more_box text-center"><a href="{$link->getPageLink('manufacturer')}" class="btn btn-default btn-more-padding btn-large" title="{l s='View more' d='Shop.Theme.Panda'}">{l s='View more' d='Shop.Theme.Panda'}</a></div>{/if}
