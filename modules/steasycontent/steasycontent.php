...
class StEasyContent extends Module implements WidgetInterface
{
    ...
    public static $location = array(
        ...
        139 => array('id' =>139 , 'name' => 'displayMainMenu' , 'hook' => 'MainMenu', 'stretched' => 1, 'full_width' => 1),
	...
	function __construct()
	{
        ...
        self::$type = array(
            ...
            11 => array('value' => 11, 'id' => 'type_11', 'label' => $this->getTranslator()->trans('Product middle section', array(), 'Modules.Steasycontent.Admin')),
	...
	public function getContent()
	{
        ...
        $this->_html .= '<script type="text/javascript">var googleFontsString=\''.json_encode($this->googleFonts).'\';var go_to_advanced_confirm="'.$this->getTranslator()->trans('Did you save all changes you just made? Unsaved changes will lose.', array(), 'Modules.Steasycontent.Admin').'"</script>';
	...
	protected function initForm()
	{
        ...
        $this->fields_form[2]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->getTranslator()->trans('Background video. MP4 format(Required):', array(), 'Admin.Theme.Panda'),
                    'name' => 'mpfour',
                    'size' => 64,
                    'desc' => array(
    ...
    protected function initColumnList($id_parent = 0, $query_string = '', $row=array())
    {
        ...
        $helper->title = (isset($row['name']) && $row['name'] ? $row['name'] : $this->getTranslator()->trans('Column list', array(), 'Modules.Steasycontent.Admin'));
    ...
    private function _prepareHook($identify, $type=1, $vc=null)
    {
		...
		$this->smarty->assign(
            array(
                ...
                'easy_image_path' => context::getContext()->link->protocol_content.(Tools::usingSecureMode() ? Tools::getShopDomainSSL() : Tools::getShopDomain()).__PS_BASE_URI__.'stupload/'.$this->name.'/',
            )
        );
    ...
    public function write_css_element_5($column){
        ...
        foreach ($column['elements'] as $element) {
            ...
            if(isset($element['st_first_btn_hover_bg']) && $element['st_first_btn_hover_bg']) {
                ...
                if($btn_fill_animation)
                    $custom_css .= $prefix_first_btn.'{-webkit-box-shadow: inset 0 0 0 0 '.$element['st_first_btn_hover_bg'].'; box-shadow: inset 0 0 0 0 '.$element['st_first_btn_hover_bg'].';}';
            ...
            if(isset($element['st_second_btn_hover_bg']) && $element['st_second_btn_hover_bg']) {
                ...
                if($btn_fill_animation)
                    $custom_css .= $prefix_first_btn.'{-webkit-box-shadow: inset 0 0 0 0 '.$element['st_second_btn_hover_bg'].'; box-shadow: inset 0 0 0 0 '.$element['st_second_btn_hover_bg'].';}';
    ...
    {
        return '<li class="divider"></li><li><a href="'.AdminController::$currentIndex.'&configure='.$this->name.'&copy'.$this->name.(Tools::getvalue('id_st_easy_content_column') ? 'element&id_st_easy_content_element=' : '&id_st_easy_content=').(int)$id.'&token='.$token.'"><i class="icon-copy"></i>'.$this->getTranslator()->trans(' Duplicate ', array(), 'Admin.Theme.Panda').'</a></li>';
    }
    ...
    private function _checkImageDir()
    {
        ...
        {
            $rs = @mkdir(_PS_ROOT_DIR_.'/stupload/'.$this->name, self::$access_rights, true)
    ...
    public function loadFormHelper($table='st_easy_content', $action='', $object = null)
    {
        $helper = new HelperForm();
        $helper->show_toolbar = false;
        $helper->id = $object->id;
    ...
    public function loadImageFieldsDesc(&$fields_form = array(), $object = null)
    {
