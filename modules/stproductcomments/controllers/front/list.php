...
class StProductCommentsListModuleFrontController extends ModuleFrontController
{
	...
	public function initContent()
	{
        ...
        else
        {
            ...
            if($id_product = (int)Tools::getValue('id_product'))
            {
                ...
                $raw_product = $assembler->assembleProduct(array(
    ...
    private function assginAll()
    {
        ...
        return array(
            ...
            // 'image_path' => context::getContext()->link->protocol_content.(Tools::usingSecureMode() ? Tools::getShopDomainSSL() : Tools::getShopDomain()).__PS_BASE_URI__.'stupload/',
