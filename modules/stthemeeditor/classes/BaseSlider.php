            ...
            'lazy' => array(
                ...
                'values' => array(
                    array(
                        'id' => 'lazy_on',
                        'value' => 1,
                        'label' => $this->getTranslator()->trans('Yes, pre load images', array(), 'Admin.Theme.Panda')),
                    array(
                        'id' => 'lazy_2',
                        'value' => 2,
                        'label' => $this->getTranslator()->trans('Yes, do\'t pre load images.', array(), 'Admin.Theme.Panda')),
                    array(
                        'id' => 'lazy_off',
                        'value' => 0,
                        'label' => $this->getTranslator()->trans('No', array(), 'Admin.Theme.Panda')),
