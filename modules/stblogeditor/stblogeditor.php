...
class StBlogEditor extends BaseSlider implements WidgetInterface
{
    ...
    public function getConfigFieldsValues()
    {
        ...
        $fields_values['meta_title'] = [];
        $fields_values['meta_keywords'] = [];
        $fields_values['meta_description'] = [];
        $fields_values['rount_name'] = [];    
    ...
    public function regenerateThumbails()
	{
        ...
        if ($images)
        {
            $path = _PS_ROOT_DIR_.'/stupload/'.'stblog/';
            $ext  = 'jpg';
    ...
    public function hookDisplayHeader($params)
    {
        ...
        if (!$this->isCached($this->templateFile[0], $this->stGetCacheId('header')))
        {
            ...
            if ($bg_img = Configuration::get($this->_prefix_st.'HEADING_BG_IMAGE')) {
                $bg_img = __PS_BASE_URI__.'stupload/'.$bg_img;
    ...
    public function hookDisplayStBlogArticleFooter($params)
    {
        ...
        if($rewind_nav && (int)Configuration::get($this->_prefix_stsn.'PRO_PER_FW')>count($related_products)){
            $rewind_nav=false;
        }
        ...
        $this->smarty->assign(array(
                ...
                'slider_reverse_direction' => Configuration::get($this->_prefix_st.'REVERSE_DIRECTION'),
                'slider_pause_on_enter' => Configuration::get($this->_prefix_st.'PAUSE_ON_ENTER'),
