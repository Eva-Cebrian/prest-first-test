...
class StHoverImage extends Module
{
		...
		$this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'name' => $this->context->link->getModuleLink('sthoverimage', 'cron', array('token' => md5('sthoverimage'))),
                ),
			),
			'submit' => array(
    ...
    public static function buildingHover($cursor = null, $length = 100)
	{
		...
		if (function_exists('memory_get_peak_usage'))
			do
			{
				$cursor = (int)self::processBuilding((int)$cursor, $length);
    ...
    private static function processBuilding($cursor, $length = 100)
	{		
		if (is_null($cursor))
			$cursor = 0;
