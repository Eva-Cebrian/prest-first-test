    ...
    {foreach $blog_categories as $p_c}
        ...
        <section class="products_section" >
            <div class="products_slider {if $p_c.grid==1} display_as_grid {elseif $p_c.grid==2} display_as_simple {/if}">
                ...
                <div class="title_block flex_container title_align_{if $column_slider}0{else}{(int)$p_c.title_align}{/if} title_style_{if isset($is_blog) && $is_blog}{(int)$sttheme.heading_style}{else}{(int)$sttheme.heading_style}{/if} {if isset($p_c.sub_title) && $p_c.sub_title} st_has_sub_title {/if}">
                ...
                {if isset($p_c.blogs) && $p_c.blogs}
                    ...
                    {if isset($p_c.reverse_direction)}
                        {$reverse_direction=$p_c.reverse_direction}
                    {/if}
                    {assign var="pause_on_enter" value=false}
                    {if isset($p_c.pause_on_enter)}
                        {$pause_on_enter=$p_c.pause_on_enter}
                    {/if}
                    ...
                    {/if}
                    {if isset($p_c.view_more) && $p_c.view_more==1 && $p_c.link}<div class="product_view_more_box text-center p-t-1"><a href="{$p_c.link}" class="btn btn-default btn-more-padding btn-large" title="{l s='View more' d='Shop.Theme.Panda'}">{l s='View more' d='Shop.Theme.Panda'}</a></div>{/if}
                {else}
