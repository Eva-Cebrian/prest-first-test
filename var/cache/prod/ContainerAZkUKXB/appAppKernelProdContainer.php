...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Cza1-szJXM', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ofNRuubpg5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BCejHfPkft', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TEOcqMPGH6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sTIRJcgR92', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1BeziYDmwk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0byLZ57Tt8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f4KyNvDomn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1baPfB4rZ7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zjByt4MF1b', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('DaqsLpbUwm', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8apljJQ4ll', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u3DKHuOk9p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('l5gV4dXRSq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-FzNkZYHL3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('s5tDLIRtOcMV26FpLpjbQeAxSXfF3f6fFGddmR1cmt0EuOGXjg4vKeO16hDKJQQx'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                11 => 'ps_wirepayment',
                12 => 'statsstock',
                13 => 'statsbestmanufacturers',
                14 => 'statsbestproducts',
                15 => 'statscarrier',
                16 => 'ps_cashondelivery',
                17 => 'statscheckup',
                18 => 'statscatalog',
                19 => 'ps_crossselling',
                20 => 'ps_dataprivacy',
                ...
                36 => 'stthemeeditor',
                37 => 'stcustomersignin',
                38 => 'stcurrencyselector',
                39 => 'stlanguageselector',
                40 => 'stmultilink',
                41 => 'stsearchbar',
                42 => 'stshoppingcart',
                43 => 'stmegamenu',
                ...
                47 => 'steasycontent',
                48 => 'stfeaturedslider',
                49 => 'stfeaturedcategories',
                50 => 'sthomenew',
                51 => 'stblog',
                52 => 'stblogeditor',
                53 => 'stblogfeaturedarticles',
                54 => 'stbanner',
                55 => 'stbrandsslider',
                56 => 'stspecialslider',
                57 => 'stblogrecentarticles',
                58 => 'stnewsletter',
                59 => 'stbestsellers',
                60 => 'stblogarchives',
                61 => 'stblogblockcategory',
                62 => 'stblogcomments',
                63 => 'stbloglinknav',
                64 => 'stblogrelatedarticles',
                65 => 'stblogsearch',
                66 => 'stblogtags',
                67 => 'stcountdown',
                68 => 'stfblikebox',
                ...
                73 => 'stnotification',
                74 => 'stpagebanner',
                75 => 'stproductcategoriesslider',
                76 => 'stproductlinknav',
                77 => 'strelatedproducts',
                78 => 'stsidebar',
                79 => 'stsocial',
                80 => 'ststickers',
                81 => 'sttwitterembeddedtimelines',
                82 => 'stvideo',
                83 => 'stviewedproducts',
                84 => 'stwishlist',
                85 => 'stproductcomments',
                86 => 'stoverride',
                87 => 'stxlfgenerator',
            ],
            ...
            'secret' => 's5tDLIRtOcMV26FpLpjbQeAxSXfF3f6fFGddmR1cmt0EuOGXjg4vKeO16hDKJQQx',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-07-05',
            'locale' => 'es-ES',
            'use_debug_toolbar' => true,
            'cookie_key' => 'gFowp49YtKsyr8Sq5vjhwp885y0XeF8Dzk4JK907sV8dhXaWmf0Qt8jrpAct7GTA',
            'cookie_iv' => 'gxY7YTVzAN6m5hpOD1fBHf4JQjzxkLOV',
            'new_cookie_key' => 'def00000b3d1f023941dba868b62728613f8267787c3bfe5f7c4c6193532c25ea03f415211f23e6ffaa3a5125bfcdb6c7518845da0a60f227fc4901e461379de03445c31',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQ
XlEhP'."\n".'0t/YfuuSxp8ipfRpz0zZWBiz1oMkH5WVAXLiP9YCW7x2iQCrCzwUUlTx4QKBgEMs'."\n".'C6ognZsYz6WgXRgt3NlEzlRzW2HgvjwyFpkhdewyyHfM7jn9uOdLv3nstSua17cN'."\n".'2qnyKBggec7PQM62pFu1+50zUjcQuV99a4NHPfNzbEBxWlGr16f9jyY4vb2CuU/1'."\n".'j0yjLD5LnpA270oKRRbk9TuW3IDxiZqtfuhXdKP5AoGBAIv7dAWffsyhoC0u50qo'."\n".'evZpocd/VyhepXNKTL+92LGmtWT599VYj9e/ifP3EPGwWMooofWXP+5TNx1A2FmU'."\n".'/943Jcm1sgPWvfwc+7urTDuAFDjpUv42Uu20asc3C4zp/YZ+1LCxxXDL8Q25ryg4'."\n".'yXqq6VLP75XnPTc66L7J8am1'."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                1 => (\dirname(__DIR__, 4).'/modules/ps_bestsellers/translations'),
                2 => (\dirname(__DIR__, 4).'/modules/ps_categorytree/translations'),
                3 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                4 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
                5 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                6 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                7 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                8 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                9 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                10 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                11 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                12 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                13 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                14 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                15 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                17 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                ...
                25 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                ...
                31 => (\dirname(__DIR__, 4).'/modules/stthemeeditor/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/stcustomersignin/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/stcurrencyselector/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/stlanguageselector/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/stmultilink/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/stsearchbar/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/stshoppingcart/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/stmegamenu/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/stswiper/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/stowlcarousel/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/sttags/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/steasycontent/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/stfeaturedslider/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/stfeaturedcategories/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/sthomenew/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/stblog/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/stblogeditor/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/stblogfeaturedarticles/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/stbanner/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/stbrandsslider/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/stspecialslider/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/stblogrecentarticles/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/stnewsletter/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/stbestsellers/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/stblogarchives/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/stblogblockcategory/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/stblogcomments/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/stbloglinknav/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/stblogrelatedarticles/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/stblogsearch/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/stblogtags/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/stcountdown/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/stfblikebox/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/sthoverimage/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/stinstagram/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/stlovedproduct/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/stcompare/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/stnotification/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/stpagebanner/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/stproductcategoriesslider/translations'),
                71 => (\dirname(__DIR__, 4).'/modules/stproductlinknav/translations'),
                72 => (\dirname(__DIR__, 4).'/modules/strelatedproducts/translations'),
                73 => (\dirname(__DIR__, 4).'/modules/stsidebar/translations'),
                74 => (\dirname(__DIR__, 4).'/modules/stsocial/translations'),
                75 => (\dirname(__DIR__, 4).'/modules/ststickers/translations'),
                76 => (\dirname(__DIR__, 4).'/modules/sttwitterembeddedtimelines/translations'),
                77 => (\dirname(__DIR__, 4).'/modules/stvideo/translations'),
                78 => (\dirname(__DIR__, 4).'/modules/stviewedproducts/translations'),
                79 => (\dirname(__DIR__, 4).'/modules/stwishlist/translations'),
                80 => (\dirname(__DIR__, 4).'/modules/stproductcomments/translations'),
                81 => (\dirname(__DIR__, 4).'/modules/stoverride/translations'),
                82 => (\dirname(__DIR__, 4).'/modules/stxlfgenerator/translations'),
            ],
            ...
            'kernel.secret' => 's5tDLIRtOcMV26FpLpjbQeAxSXfF3f6fFGddmR1cmt0EuOGXjg4vKeO16hDKJQQx',
