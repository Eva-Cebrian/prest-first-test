 ...
 flex_container <?php if ($_smarty_tpl->tpl_vars['sttheme']->value['flyout_buttons_on_mobile'] == 1) {?> mobile_hover_fly_show <?php } elseif ($_smarty_tpl->tpl_vars['sttheme']->value['flyout_buttons_on_mobile'] == 2) {?> mobile_hover_fly_cart <?php } else { ?> mobile_hover_fly_hide <?php }?>">
          <?php if (!$_smarty_tpl->tpl_vars['sttheme']->value['display_add_to_cart'] && $_smarty_tpl->tpl_vars['sttheme']->value['pro_quantity_input'] != 1 && $_smarty_tpl->tpl_vars['sttheme']->value['pro_quantity_input'] != 3) {?>
            <?php if ($_smarty_tpl->tpl_vars['has_add_to_cart']->value) {?>
              <?php $_smarty_tpl->_subTemplateRender('file:catalog/_partials/miniatures/btn-add-to-cart.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
            <?php } elseif ($_smarty_tpl->tpl_vars['sttheme']->value['show_hide_add_to_cart'] == 2) {?>
                <?php $_smarty_tpl->_subTemplateRender('file:catalog/_partials/miniatures/btn-view-more.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
            <?php } elseif ($_smarty_tpl->tpl_vars['sttheme']->value['show_hide_add_to_cart'] == 3) {?>
                <?php $_smarty_tpl->_subTemplateRender('file:catalog/_partials/miniatures/btn-quick-view.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
                            <?php }?>
          <?php }?>
...
$_smarty_tpl->_assignInScope('classname_flyout_quickview', 'display_none');
            ...
            <?php $_smarty_tpl->_subTemplateRender('file:catalog/_partials/miniatures/btn-quick-view.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('classname'=>$_smarty_tpl->tpl_vars['classname_flyout_quickview']->value), 0, true);
?>
          <?php }?>
...
$_smarty_tpl->_subTemplateRender('file:catalog/_partials/miniatures/btn-view-more.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
}?>
          <?php if ((isset($_smarty_tpl->tpl_vars['wishlist_position']->value)) && !$_smarty_tpl->tpl_vars['wishlist_position']->value) {?>
            <?php $_smarty_tpl->_subTemplateRender('module:stwishlist/views/templates/hook/fly.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('is_wished'=>((isset($_smarty_tpl->tpl_vars['product']->value['stwishlist']['wished'])) && $_smarty_tpl->tpl_vars['product']->value['stwishlist']['wished']),'fromnocache'=>((isset($_smarty_tpl->tpl_vars['for_w']->value)) && $_smarty_tpl->tpl_vars['for_w']->value == 'category')), 0, false);
?>
          <?php }?>
          <?php if ((isset($_smarty_tpl->tpl_vars['loved_position']->value)) && !$_smarty_tpl->tpl_vars['loved_position']->value) {?>
            <?php $_smarty_tpl->_subTemplateRender('module:stlovedproduct/views/templates/hook/fly.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('id_source'=>$_smarty_tpl->tpl_vars['product']->value['id_product'],'is_loved'=>((isset($_smarty_tpl->tpl_vars['product']->value['stlovedproduct']['loved'])) && $_smarty_tpl->tpl_vars['product']->value['stlovedproduct']['loved']),'fromnocache'=>((isset($_smarty_tpl->tpl_vars['for_w']->value)) && $_smarty_tpl->tpl_vars['for_w']->value == 'category')), 0, false);
?>
          <?php }?>
...
$_smarty_tpl->_assignInScope('classname_flyout_stcompare', 'display_none');
            ...
            <?php $_smarty_tpl->_subTemplateRender('module:stcompare/views/templates/hook/fly.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('id_product'=>$_smarty_tpl->tpl_vars['product']->value['id_product'],'is_compared'=>((isset($_smarty_tpl->tpl_vars['product']->value['stcompare']['compared'])) && $_smarty_tpl->tpl_vars['product']->value['stcompare']['compared']),'fromnocache'=>((isset($_smarty_tpl->tpl_vars['for_w']->value)) && $_smarty_tpl->tpl_vars['for_w']->value == 'category'),'classname'=>$_smarty_tpl->tpl_vars['classname_flyout_stcompare']->value), 0, false);
?>
          <?php }?>
...
$_smarty_tpl->_assignInScope('classname_flyout_share', 'display_none');
            ...
            <?php $_smarty_tpl->_subTemplateRender('module:stsocial/views/templates/hook/stsocial-hover-fly.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('classname'=>$_smarty_tpl->tpl_vars['classname_flyout_share']->value), 0, false);
?>
          <?php }?>
      </div><?php }
}
