...
<section id="stspecialslider_footer_8270625bcb" class="stspecialslider_footer footer_block block  col-lg-3 ">
    <div class="title_block">
                <a href="//localhost:8000/index.php?controller=prices-drop" class="title_block_inner" title="Promociones especiales">Promociones especiales</a>
  ...
  <div class="pro_column_right">
    <h3  class="s_title_block nohidden"><a href="http://localhost:8000/index.php?id_product=1&amp;id_product_attribute=1&amp;rewrite=hummingbird-printed-t-shirt&amp;controller=product#/1-tamano-s/8-color-blanco" title="Hummingbird printed t-shirt" >Hummingbird printed t-shirt</a></h3>
  ...
  <div class="pro_column_right">
    <h3  class="s_title_block nohidden"><a href="http://localhost:8000/index.php?id_product=2&amp;id_product_attribute=9&amp;rewrite=brown-bear-printed-sweater&amp;controller=product#/1-tamano-s" title="Hummingbird printed sweater" >Hummingbird printed sweater</a></h3>
