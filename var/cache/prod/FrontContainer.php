...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->services['annotation_reader'] ?? ($this->services['annotation_reader'] = new \Doctrine\Common\Annotations\AnnotationReader())), [0 => '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/var/cache/prod//doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop', '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/modules/');
    }
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(($this->services['prestashop.core.localization.cldr.cache.adapter'] ?? ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/var/cache/prod//localization'))));
    ...
    {
        return $this->services['prestashop.translation.translator_language_loader'] = new \PrestaShopBundle\Translation\TranslatorLanguageLoader(($this->services['prestashop.adapter.module.repository.module_repository'] ?? ($this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop', '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/modules/'))));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.root_dir' => '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/app',
            'kernel.project_dir' => '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/var/cache/prod/',
            ...
            'ps_cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/XAMPP/xamppfiles/htdocs/tienda-prestashop/var/cache/prod//doctrine/orm/Proxies',
